...
// RegisterNode
func (h *RpcHandler) RegisterNode(nodeInfo NodeInfo, result *JsonResult) error {
...
func (h *RpcHandler) RegisterHttpExecutor(config interface{}, result *JsonResult) error {
