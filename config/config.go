...
func DefaultProfile() *Profile {
	...
	p.Rpc = &RpcSection{RpcHost: "", RpcPort: "2398", ServerCertFile: "tls/server.crt", ServerKeyFile: "tls/server.key", ClientCertFile: "tls/client.crt", ClientKeyFile: "tls/client.key"}
